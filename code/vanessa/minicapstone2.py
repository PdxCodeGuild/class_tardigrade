...
# schedule.every(15).to(30).minutes.do(goal5(met_goals))
# # schedule.every(5).to(10).days.do(goal1)
# schedule.every(1).hour.do(goal2,(met_goals))
# schedule.every().day.at("11:33").do(goal2(met_goals))
# schedule.every().day.at("09:30").do(goal3(met_goals))
# schedule.every().day.at("06:00").do(goal4(met_goals))
