"""
Django settings for lab_grocery_list project.
...
SECRET_KEY = 'django-insecure-7d1g2nw#bpb56s&0i%42d*%3je)up78^1vjqi-q*#+)lec^=gi'
...
ROOT_URLCONF = 'lab_grocery_list.urls'
