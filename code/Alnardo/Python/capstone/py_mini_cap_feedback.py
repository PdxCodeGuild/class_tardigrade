...
import numpy as np
from numpy import tan, sin, cos # you could import these like so, and no have to declare the variables later
...
if welcome == 't' or welcome == 'trig':
    trig() # you could encapuslate all this logic into a function to make your repl easier to navigate
